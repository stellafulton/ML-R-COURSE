...
```{r LOOIC values}
# not much point comparing these because the random intercept and random slope model didn't even work so can't compare a model that ran well and a model that didn't run weel
